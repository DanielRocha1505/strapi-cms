...
export interface ApiCategoryCategory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    rank: Attribute.Integer & Attribute.Private;
...
export interface ApiGlobalGlobal extends Schema.SingleType {
  ...
  attributes: {
    ...
    favicon: Attribute.Media<'files' | 'images' | 'videos'>;
...
export interface ApiPagePage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    description: Attribute.String;
    before: Attribute.DynamicZone<['blocks.hero']>;
    content: Attribute.RichText;
    after: Attribute.DynamicZone<
      [
        'blocks.latest-news',
        'blocks.carousel',
        'blocks.faq',
...
export interface ApiWriterWriter extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    picture: Attribute.Media<'files' | 'images' | 'videos'>;
    articles: Attribute.Relation<
      'api::writer.writer',
      'oneToMany',
      'api::article.article'
